package com.sarvex.gameoflife.webtests.steps;

import com.sarvex.gameoflife.webtests.pages.EnterGridPage;
import com.sarvex.gameoflife.webtests.pages.GameOfLifePage;
import com.sarvex.gameoflife.webtests.pages.HomePage;
import com.sarvex.gameoflife.webtests.pages.ShowGridPage;
...
public class PlayerSteps {
    ...
    public void should_see_title_of(String expectedTitle) {
        Assertions.assertThat(currentPage().getTitle()).contains(expectedTitle);
    }
    ...
    public void should_see_grid(String[][] expectedGrid) {
        Assertions.assertThat(onShowGridPage().getDisplayedGrid()).isEqualTo(expectedGrid);
    }
