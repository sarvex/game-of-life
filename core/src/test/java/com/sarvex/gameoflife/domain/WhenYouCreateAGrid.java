...
public class WhenYouCreateAGrid {
  ...
  public void shouldBeAbleToReadTheStateOfALivingCell() {
    ...
    int x = 0;
    int y = 1;
    assertThat(grid.getCellAt(x, y), Matchers.is(Cell.LIVE_CELL));
  }
  ...
  public void shouldBeAbleToReadTheStateOfADeadCell() {
    ...
    int x = 1;
    int y = 0;
    assertThat(grid.getCellAt(x, y), Matchers.is(Cell.DEAD_CELL));
  }
  ...
  public void shouldBeAbleToObtainTheGridContentsAsAnArray() {
    ...
    assertThat(contents[0][0], Matchers.is(Cell.LIVE_CELL));
    assertThat(contents[1][0], Matchers.is(Cell.LIVE_CELL));
    assertThat(contents[2][1], Matchers.is(Cell.LIVE_CELL));
  }
  ...
  public void ModifyingTheGridContentsAsAnArrayShouldNotModifyTheOriginalContents() {
    ...
    Cell[][] contents = grid.getContents();
    contents[1][1] = Cell.DEAD_CELL;

    assertThat(grid.getCellAt(1, 1), Matchers.is(Cell.LIVE_CELL));
  }
